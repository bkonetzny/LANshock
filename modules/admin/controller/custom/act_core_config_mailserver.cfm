...
$HeadURL: https://lanshock.svn.sourceforge.net/svnroot/lanshock/trunk/scaffolding/templates/EXT2.0/custom/admin/raw_files/controller/custom/act_core_config_mailserver.cfm $
...
<cfif attributes.form_submitted>
	...
	<cfif NOT ArrayLen(aError)>
		...
		<cfset stModuleConfigNew.settings.mailserver.server = attributes.server>
		<cfset stModuleConfigNew.settings.mailserver.port = attributes.port>
		<cfset stModuleConfigNew.settings.mailserver.username = attributes.username>
		<cfset stModuleConfigNew.settings.mailserver.password = attributes.password>
		<cfset stModuleConfigNew.settings.mailserver.from = attributes.from>
