...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/core/admin/user.cfc $
...
<cfcomponent>
	...
	<cffunction name="getRoles" access="public" returntype="query" output="false">
		...
		<cfquery name="qRoles" datasource="#application.lanshock.environment.datasource#">
			SELECT *
