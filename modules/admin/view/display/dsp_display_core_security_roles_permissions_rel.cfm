<cfsilent>
<!--- -->
<fusedoc fuse="$RCSfile: dsp_display_core_security_roles_permissions_rel.cfm,v $" language="ColdFusion 7.01" version="2.0">
	<responsibilities>
		I display a single core_security_roles_permissions_rel record from an object, a structure, a query or from attributes scope.
	</responsibilities>
	<properties>
		...
		<property name="lastupdated" value="$Date: 2008-03-09 12:47:41 +0100 (So, 09 Mrz 2008) 2008/05/31 14:33:56 $" />
	...
	<io>
		<in>
			...
			<object name="ocore_security_roles_permissions_rel" comments="The record object to be displayed." optional="Yes" />
			
			<structure name="stcore_security_roles_permissions_rel" comments="Not used if ocore_security_roles_permissions_rel is provided." optional="Yes" >
				
				<integer name="permission_id" />
			...
			<recordset name="qcore_security_roles_permissions_rel" primaryKeys="id" scope="variables" optional="Yes" comments="Recordset containing core_security_roles_permissions_rel records " >
				<integer name="permission_id" />
				<integer name="role_id" />
				<integer name="id" />
			...
			<integer name="permission_id" scope="attributes" optional="Yes" comments="Not used if ocore_security_roles_permissions_rel, stcore_security_roles_permissions_rel or qcore_security_roles_permissions_rel is provided." />
			<integer name="role_id" scope="attributes" optional="Yes" comments="Not used if ocore_security_roles_permissions_rel, stcore_security_roles_permissions_rel or qcore_security_roles_permissions_rel is provided." />
			<integer name="id" scope="attributes" optional="Yes" comments="Not used if ocore_security_roles_permissions_rel, stcore_security_roles_permissions_rel or qcore_security_roles_permissions_rel is provided." />
...
<cfif isDefined("ocore_security_roles_permissions_rel")>
	<!--- Get variables from the object. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfif ListFindNoCase(_joinedFieldlist,thisField)>
			<cfset setvariable("variables.#thisField#", evaluate("ocore_security_roles_permissions_rel.get" & stJoinedFields[thisField] & "().get" & thisField & "()"))>
		<cfelse>
			<cfset setvariable("variables.#thisField#", evaluate("ocore_security_roles_permissions_rel.get" & thisField & "()"))>
		</cfif>
	</cfloop>
<cfelseif isDefined("stcore_security_roles_permissions_rel")>
	<!--- Copy variables from the structure. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfset setvariable("variables.#thisField#", stcore_security_roles_permissions_rel[thisField])>
	</cfloop>
<cfelseif isDefined("qcore_security_roles_permissions_rel")>
	<cfparam name="_recordNumber" default="1">
	<!--- Copy variables from the query. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfset setvariable("variables.#thisField#", qcore_security_roles_permissions_rel[thisField][_recordNumber])>
	</cfloop>
<cfelse>
...
<!--- Start of the form --->
<cfoutput>
	<table width="590" border="0" cellpadding="2" cellspacing="2" summary="This table shows details of a single core_security_roles_permissions_rel record." class="">
		...
		<cfloop list="#fieldlist#" index="thisField">
		  <cfswitch expression="#thisField#">
			...
			<cfcase value="permission_id">
				<tr>
				  <cfif ListFindNocase(highlightfields,'permission_id')>
				  ...
				  <cfelse>
					...
					<td>
						#NumberFormat(variables.permission_id,"9.99")#
					</td>
				</tr>
			</cfcase>
			<cfcase value="role_id">
				<tr>
				  ...
				  <cfelse>
					...
					<td>
						#NumberFormat(variables.role_id,"9.99")#
					</td>
				</tr>
			</cfcase>
			<cfcase value="id">
