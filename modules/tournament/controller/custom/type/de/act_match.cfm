...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/act_type_de_match.cfm $
...
<cfif session.oUser.checkPermissions('manage')>
	...
	<cfif qTournament.status EQ 'playing' AND attributes.calculateMatches>
		<cfinvoke component="#application.lanshock.oFactory.load(bCache=false,sObject='lanshock.modules.tournament.model.type_de')#" method="calculateMatches">
...
<cfif NOT application.lanshock.oCache.exists(sCacheKey)>
	...
	<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_de')#" method="getMatches" returnvariable="qMatches">
		<cfinvokeargument name="tournamentid" value="#qTournament.id#">
	</cfinvoke>
