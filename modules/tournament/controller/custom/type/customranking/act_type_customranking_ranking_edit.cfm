...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/act_type_customranking_ranking_edit.cfm $
...
<cfif attributes.form_submitted>
	...
	<cfinvoke component="type_customranking" method="setRanking" returnvariable="qRanking">
		<cfinvokeargument name="tournamentid" value="#qTournament.id#">
		<cfinvokeargument name="ranking" value="#stRanking#">
	</cfinvoke>
	
	<cflocation url="#myself##myfusebox.thiscircuit#.ranking&tournamentid=#qTournament.id#&#session.urltoken#" addtoken="false">
	
</cfif>

<cfinvoke component="type_customranking" method="getRanking" returnvariable="qRanking">
	<cfinvokeargument name="tournamentid" value="#qTournament.id#">
</cfinvoke>
