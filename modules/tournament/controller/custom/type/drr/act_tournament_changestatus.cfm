...
<cfif sStatusNew EQ 'signup'>
	<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_drr')#" method="resetAllMatches">
...
<cfif sStatusOld EQ 'signup' AND sStatusNew EQ 'warmup'>
	<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_drr')#" method="createAllMatches">
		<cfinvokeargument name="tournamentid" value="#qTournament.id#">
	</cfinvoke>
...
<cfif sStatusNew EQ 'done'>
	<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_drr')#" method="calculateRanking">
