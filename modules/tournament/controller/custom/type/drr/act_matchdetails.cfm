...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/act_type_drr_matchdetails.cfm $
...
<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_drr')#" method="getMatch" returnvariable="stMatch">
...
<cfif attributes.form_submitted>
	...
	<cfif session.oUser.checkPermissions('manage')>
		<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_drr')#" method="updateMatch">
			<cfinvokeargument name="tournamentid" value="#qTournament.id#">
			<cfinvokeargument name="matchid" value="#attributes.matchid#">
...
<cfelseif attributes.form_submitted4>
	...
	<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_drr')#" method="updateResults">
		<cfinvokeargument name="matchid" value="#attributes.matchid#">
...
<cfif stMatch.status EQ 'empty' AND session.oUser.checkPermissions('manage')>
	...
	<cfif stMatch.col-1 GTE 1>
		...
		<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_drr')#" method="getMatchesByCol" returnvariable="qMatches">
			<cfinvokeargument name="tournamentid" value="#qTournament.id#">
