...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/act_export_generate_wwcl.cfm $
...
<cfloop list="#attributes.tournament_export_ids#" index="idx">
	...
	<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.tournaments')#" method="getTournamentData" returnvariable="qTournamentData">
		...
		<tourney>
			...
			<cfswitch expression="#type#">
				<cfcase value="se">
					...
					<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_se')#" method="generateWwclExport" returnvariable="exportContent">
						<cfinvokeargument name="tournamentid" value="#idx#">
...
<cffile action="write" file="#application.lanshock.oHelper.UDF_Module('absPath')#/export/export.wwcl.xml" output="#toString(xmlexport)#" addnewline="true">
