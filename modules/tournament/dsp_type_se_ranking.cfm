...
<cfif request.session.isAdmin>
	<a href="#myself##myfusebox.thiscircuit#.ranking_edit&tournamentid=#qTournament.id#&#request.session.urltoken#" class="link_extended">#request.content.type_se_ranking_edit#</a>
</cfif>
