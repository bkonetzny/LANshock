...
<cfif NOT ListFind('signup,warmup',qTournament.status) AND qGroups.recordcount EQ 1 AND attributes.showGroupDetails NEQ qGroups.id>
	<cflocation url="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&showGroupDetails=#qGroups.id#&#request.session.urltoken#" addtoken="false">
</cfif>

<cfoutput>
	<div class="headline2">#request.content.type_group_match_headline#</div>
	<cfif request.session.isAdmin>
		<div align="center">
			<cfif qTournament.status EQ 'warmup'>
				<a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&randomize_first_round=true&tournamentid=#qTournament.id#&#request.session.urltoken#" class="link_extended">#request.content.type_group_match_randomize_groups#</a><br>
				<br>
			</cfif>
			...
			<cfif id EQ attributes.showGroupDetails>
				...
				<table cellpadding="0" cellspacing="5" align="center">
					...
					<cfloop query="qTeams">
						...
						<tr>
							<td><a href="#myself##myfusebox.thiscircuit#.team_details&teamid=#id#&tournamentid=#attributes.tournamentid#&#request.session.urltoken#">#name#</a></td>
							...
							<cfloop query="qTeams">
								...
								<cfelse>
									...
									<cfif NOT qMatchdata.recordcount>
										...
										<cflocation url="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&showGroupDetails=#attributes.showGroupDetails#&#request.session.urltoken#" addtoken="false">
									</cfif>
									...
									<td align="center" style="border: 1px solid gray; border-bottom: 4px solid <cfif bStatsW>green<cfelseif bStatsL>red<cfelseif bStatsD>orange<cfelse>##CCCCCC</cfif>;" title="#name#"><a href="#myself##myfusebox.thiscircuit#.matchdetails&tournamentid=#qTournament.id#&matchid=#qMatchdata.id#&#request.session.urltoken#">&nbsp;&nbsp;<cfif bStatsW>#request.content.type_group_stats_key_win#<cfelseif bStatsL>#request.content.type_group_stats_key_loss#<cfelseif bStatsD>#request.content.type_group_stats_key_draw#<cfelse>?</cfif>&nbsp;&nbsp;</a></td>
								</cfif>
							</cfloop>
							<td>&nbsp;</td>
	...
	<cfelse>
		<table cellpadding="0" cellspacing="0" align="center" width="60%">
			<cfloop query="qGroups">
				...
				<tr>
					<td><a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&showGroupDetails=#id#&#request.session.urltoken#"><strong>#name#</strong></a></td>
					<td align="right"><cfif ListFind('signup,warmup',qTournament.status)><a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&grouphandler_delete=#id#&#request.session.urltoken#" title="#request.content.form_delete#"><img src="#stImageDir.general#/btn_delete.gif" alt="#request.content.form_delete#"></a></cfif></td>
				</tr>
				<tr>
