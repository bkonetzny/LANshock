<cfcomponent displayname="tournament_matchGateway.cfc" extends="reactor.project.lanshock.Gateway.tournament_matchGateway">
...
<cfset variables.sOptionNameField = "tournamentid">
	...
	<cffunction name="getRecords" access="public" hint="I return all matching rows from the table." output="false" returntype="query">
		...
		<cfif NOT StructIsEmpty(arguments.stFilter)>
			...
			<cfif StructKeyExists(arguments.stFilter,'stJoins')>
				<cfset Query.returnObjectFields("tournament_match","id,tournamentid,status,row,col,team1,team2,winner,submittedby_userid,submittedby_teamid,submittedby_dt,checkedby_userid,checkedby_teamid,checkedby_dt,checkedby_admin,checkedby_admin_dt")>
				
				<cfloop collection="#arguments.stFilter.stJoins#" item="idx">
					<cfset idx = lCase(idx)>
					<cfset Query.leftJoin("tournament_match",idx,idx)>
			...
			<cfif StructKeyExists(arguments.stFilter,'stFields')>
				<cfloop collection="#arguments.stFilter.stFields#" item="idx">
					...
					<cfelse>
						<cfset sCurrentTable = "tournament_match">
			...
			<cfif StructKeyExists(arguments.stFilter,'lSortFields')>
				<cfloop list="#arguments.stFilter.lSortFields#" index="idx">
					...
					<cfif ListLen(idx,'|') EQ 2>
						<cfset idx = ListPrepend(idx,"tournament_match",'|')>
					</cfif>
	...
	<cffunction name="getAllWithJoin" output="false" returntype="query" hint="I get ALL the records, with an outer join to any parent tables.">
		...
		<cfset Query.leftJoin("tournament_match", "tournament_tournament", "tournament_tournament")/>
	...
	<cffunction name="getNWithJoin" output="false" returntype="query" hint="I get the selected N records, with an outer join to any parent tables.">
		...
		<cfif arguments.startrow GT 1>
			...
			<cfset QuerySkip.returnObjectFields("tournament_match","id") />
			<cfset QuerySkip.setMaxrows(arguments.startrow) />
			<cfset qSkip = getByQuery(QuerySkip) />
			<cfset where.isNotIn("tournament_match","id",valuelist(qSkip.id)) />
		</cfif>
	  
		<!--- Left join all the associated tables (uses a left join for safety). --->
		<!--- Syntax is: Query.leftJoin(joinFromObjectAlias,joinToObjectAlias,relationshipAlias) --->
	  
		<cfset QueryRecordset.leftJoin("tournament_match", "tournament_tournament", "tournament_tournament")/>
		...
		<cfif isStruct(arguments.filter)>
			<cfset QueryRecordset.getWhere().setMode("OR")>
				...
				<cfif StructKeyExists(arguments.filter,'id')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'id',arguments.filter['id'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'tournamentid')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'tournamentid',arguments.filter['tournamentid'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'status')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'status',arguments.filter['status'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'row')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'row',arguments.filter['row'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'col')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'col',arguments.filter['col'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'team1')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'team1',arguments.filter['team1'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'team2')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'team2',arguments.filter['team2'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'winner')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'winner',arguments.filter['winner'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'submittedby_userid')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'submittedby_userid',arguments.filter['submittedby_userid'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'submittedby_teamid')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'submittedby_teamid',arguments.filter['submittedby_teamid'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'submittedby_dt')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'submittedby_dt',arguments.filter['submittedby_dt'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'checkedby_userid')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'checkedby_userid',arguments.filter['checkedby_userid'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'checkedby_teamid')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'checkedby_teamid',arguments.filter['checkedby_teamid'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'checkedby_dt')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'checkedby_dt',arguments.filter['checkedby_dt'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'checkedby_admin')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'checkedby_admin',arguments.filter['checkedby_admin'])>
					</cfif>
				</cfif>
				...
				<cfif StructKeyExists(arguments.filter,'checkedby_admin_dt')>
					...
					<cfif bFilterColumn>
						<cfset QueryRecordset.getWhere().isLike("tournament_match",'checkedby_admin_dt',arguments.filter['checkedby_admin_dt'])>
					</cfif>
				</cfif>
		...
		<cfset QueryRecordset.returnObjectFields("tournament_match","id,tournamentid,status,row,col,team1,team2,winner,submittedby_userid,submittedby_teamid,submittedby_dt,checkedby_userid,checkedby_teamid,checkedby_dt,checkedby_admin,checkedby_admin_dt")>
	...
	<cffunction name="getOptions" access="remote" output="false" returntype="query" hint="I get the option values for this table.">
		...
		<cfif len(variables.sOptionNameCode)>
			<cfset QueryRecordset.setFieldExpression("tournament_match",variables.sOptionNameField,variables.sOptionNameCode)>
		</cfif>
		<cfset QueryRecordset.setFieldAlias("tournament_match","id","optionvalue")>
		<cfset QueryRecordset.setFieldAlias("tournament_match",variables.sOptionNameField,"optionname")>
		<cfset QueryRecordset.returnObjectFields("tournament_match","optionvalue,optionname")>
	...
	<cffunction name="getRecordCount" output="false" returntype="numeric" hint="I get the number of records in the table.">
		...
		<cfset QueryCount.returnObjectFields("tournament_match","id") />
		<cfset QueryCount.setFieldExpression("tournament_match","id","COUNT(*)","CF_SQL_INTEGER") />
