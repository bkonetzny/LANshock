...
<cfoutput>
<div class="headline2">#request.content.type_group_ranking_headline#</div>
<br><br>
<cfif request.session.isAdmin>
	<a href="#myself##myfusebox.thiscircuit#.ranking_edit&tournamentid=#qTournament.id#&#request.session.urltoken#" class="link_extended">#request.content.type_group_ranking_edit#</a>
</cfif>
