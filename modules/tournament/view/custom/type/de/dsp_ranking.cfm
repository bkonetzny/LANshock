...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/dsp_type_de_ranking.cfm $
...
<cfoutput>
<h4>#request.content.type_de_ranking_headline#</h4>

<cfif session.oUser.checkPermissions('manage')>
	<a href="#myself##myfusebox.thiscircuit#.ranking_edit&tournamentid=#qTournament.id#&#session.urltoken#" class="link_extended">#request.content.type_de_ranking_edit#</a>
</cfif>
