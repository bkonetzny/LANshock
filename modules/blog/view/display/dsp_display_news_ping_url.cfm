<cfsilent>
<!--- -->
<fusedoc fuse="$RCSfile: dsp_display_news_ping_url.cfm,v $" language="ColdFusion 7.01" version="2.0">
	<responsibilities>
		I display a single news_ping_url record from an object, a structure, a query or from attributes scope.
	</responsibilities>
	<properties>
	...
	<io>
		<in>
			...
			<object name="onews_ping_url" comments="The record object to be displayed." optional="Yes" />
			
			<structure name="stnews_ping_url" comments="Not used if onews_ping_url is provided." optional="Yes" >
			...
			<recordset name="qnews_ping_url" primaryKeys="id" scope="variables" optional="Yes" comments="Recordset containing news_ping_url records " >
				<integer name="id" />
				<string name="name" />
				<string name="url" />
			...
			<integer name="id" scope="attributes" optional="Yes" comments="Not used if onews_ping_url, stnews_ping_url or qnews_ping_url is provided." />
			<string name="name" scope="attributes" optional="Yes" comments="Not used if onews_ping_url, stnews_ping_url or qnews_ping_url is provided." />
			<string name="url" scope="attributes" optional="Yes" comments="Not used if onews_ping_url, stnews_ping_url or qnews_ping_url is provided." />
...
<cfparam name="variables.fieldlist" default="id,name,url,">
<cfset _joinedFieldlist="">
<cfif isDefined("onews_ping_url")>
	<!--- Get variables from the object. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfif ListFindNoCase(_joinedFieldlist,thisField)>
			<cfset setvariable("variables.#thisField#", evaluate("onews_ping_url.get" & stJoinedFields[thisField] & "().get" & thisField & "()"))>
		<cfelse>
			<cfset setvariable("variables.#thisField#", evaluate("onews_ping_url.get" & thisField & "()"))>
		</cfif>
	</cfloop>
<cfelseif isDefined("stnews_ping_url")>
	<!--- Copy variables from the structure. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfset setvariable("variables.#thisField#", stnews_ping_url[thisField])>
	</cfloop>
<cfelseif isDefined("qnews_ping_url")>
	<cfparam name="_recordNumber" default="1">
	<!--- Copy variables from the query. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfset setvariable("variables.#thisField#", qnews_ping_url[thisField][_recordNumber])>
	</cfloop>
<cfelse>
...
<!--- Start of the form --->
<cfoutput>
	<table width="590" border="0" cellpadding="2" cellspacing="2" summary="This table shows details of a single news_ping_url record." class="">
