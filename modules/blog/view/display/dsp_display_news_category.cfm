<cfsilent>
<!--- -->
<fusedoc fuse="$RCSfile: dsp_display_news_category.cfm,v $" language="ColdFusion 7.01" version="2.0">
	<responsibilities>
		I display a single news_category record from an object, a structure, a query or from attributes scope.
	</responsibilities>
	<properties>
		...
		<property name="lastupdated" value="$Date: 2008-03-09 12:47:41 +0100 (So, 09 Mrz 2008) 2008/05/06 21:06:02 $" />
	...
	<io>
		<in>
			...
			<object name="onews_category" comments="The record object to be displayed." optional="Yes" />
			
			<structure name="stnews_category" comments="Not used if onews_category is provided." optional="Yes" >
			...
			<recordset name="qnews_category" primaryKeys="id" scope="variables" optional="Yes" comments="Recordset containing news_category records " >
				<integer name="id" />
				<string name="name" />
			...
			<integer name="id" scope="attributes" optional="Yes" comments="Not used if onews_category, stnews_category or qnews_category is provided." />
			<string name="name" scope="attributes" optional="Yes" comments="Not used if onews_category, stnews_category or qnews_category is provided." />
...
<cfif isDefined("onews_category")>
	<!--- Get variables from the object. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfif ListFindNoCase(_joinedFieldlist,thisField)>
			<cfset setvariable("variables.#thisField#", evaluate("onews_category.get" & stJoinedFields[thisField] & "().get" & thisField & "()"))>
		<cfelse>
			<cfset setvariable("variables.#thisField#", evaluate("onews_category.get" & thisField & "()"))>
		</cfif>
	</cfloop>
<cfelseif isDefined("stnews_category")>
	<!--- Copy variables from the structure. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfset setvariable("variables.#thisField#", stnews_category[thisField])>
	</cfloop>
<cfelseif isDefined("qnews_category")>
	<cfparam name="_recordNumber" default="1">
	<!--- Copy variables from the query. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfset setvariable("variables.#thisField#", qnews_category[thisField][_recordNumber])>
	</cfloop>
<cfelse>
...
<!--- Start of the form --->
<cfoutput>
	<table width="590" border="0" cellpadding="2" cellspacing="2" summary="This table shows details of a single news_category record." class="">
