<cfscript>
	...
	if (fb_.verbInfo.executionMode is "start") {
		...
		if (structKeyExists(fb_.verbInfo.attributes,"bean")) {
			...
			fb_appendLine('<cfset #fb_.returnvariable#myFusebox.getApplication().getApplicationData().#fb_.coldspringfactory#.getBeanDefinition(beanName="#fb_.verbInfo.attributes.beanDefinition#")/> ');
		} else {
