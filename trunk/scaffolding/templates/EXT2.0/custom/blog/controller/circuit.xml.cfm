<cfoutput>
	<fuseaction access="public" name="news">
		<include circuit="c_#sModule#" template="act_news"/>
		<include circuit="v_#sModule#" template="dsp_news"/>
	</fuseaction>
	
	<fuseaction access="public" name="archive">
		<include circuit="c_#sModule#" template="act_archive"/>
	...
	<fuseaction access="public" name="news_comment_edit">
		...
		<include circuit="c_#sModule#" template="act_news_comment_edit"/>
	</fuseaction>
