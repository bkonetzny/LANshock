...
<cfif attributes.randomize_first_round AND qTournament.status EQ 'warmup'>
	...
	<cfinvoke component="type_se" method="getMatchesByCol" returnvariable="qMatchesFirstRound">
...
<cfinvoke component="type_se" method="getMatches" returnvariable="qMatches">
	<cfinvokeargument name="tournamentid" value="#qTournament.id#">
</cfinvoke>
