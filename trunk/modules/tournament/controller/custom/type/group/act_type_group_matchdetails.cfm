...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/act_type_group_matchdetails.cfm $
...
<cfinvoke component="type_group" method="getMatch" returnvariable="stMatch">
...
<cfif attributes.form_submitted>
	...
	<cfinvoke component="type_group" method="updateMatch">
		<cfinvokeargument name="tournamentid" value="#qTournament.id#">
		<cfinvokeargument name="matchid" value="#attributes.matchid#">
	...
	<cflocation url="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&matchid=#attributes.matchid#&tournamentid=#qTournament.id#&#session.urltoken#" addtoken="false">
...
<cfelseif attributes.form_submitted4>
	...
	<cfif isDefined("attributes.finish")>
		...
		<cfinvoke component="type_group" method="updateResults">
			<cfinvokeargument name="matchid" value="#attributes.matchid#">
...
<!--- <cfif stMatch.status EQ 'empty' AND session.oUser.checkPermissions('manage')>
	...
	<cfif stMatch.col NEQ iRowCountL+1>
		...
		<cfif stMatch.col-1 LTE iRowCountL>
			...
			<cfinvoke component="type_group" method="getMatchesByCol" returnvariable="qMatches">
				<cfinvokeargument name="tournamentid" value="#qTournament.id#">
