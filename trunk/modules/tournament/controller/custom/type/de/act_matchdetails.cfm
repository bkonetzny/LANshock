...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/act_type_de_matchdetails.cfm $
...
<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_de')#" method="getMatch" returnvariable="stMatch">
...
<cfelseif attributes.form_submitted4>
	...
	<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_de')#" method="updateResults">
		<cfinvokeargument name="matchid" value="#attributes.matchid#">
...
<cfif stMatch.status EQ 'empty' AND session.oUser.checkPermissions('manage')>
	...
	<cfif stMatch.col NEQ iRowCountL+1>
		...
		<cfif stMatch.col-1 LTE iRowCountL>
			...
			<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_de')#" method="getMatchesByCol" returnvariable="qMatches">
				<cfinvokeargument name="tournamentid" value="#qTournament.id#">
				<cfinvokeargument name="col" value="#stMatch.col+1#">
			</cfinvoke>
		
			<cfloop query="qMatches">
				<cfif stMatch.col EQ iRowCountL>
