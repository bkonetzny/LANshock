...
<cfinvoke component="type_se" method="getMatch" returnvariable="stMatch">
...
<cfif attributes.form_submitted>
	...
	<cfinvoke component="type_se" method="updateMatch">
		<cfinvokeargument name="tournamentid" value="#qTournament.id#">
		<cfinvokeargument name="matchid" value="#attributes.matchid#">
...
<cfelseif attributes.form_submitted4>
	...
	<cfif isDefined("attributes.finish")>
		...
		<cfinvoke component="type_se" method="updateResults">
			<cfinvokeargument name="matchid" value="#attributes.matchid#">
...
<cfif stMatch.status EQ 'empty' AND request.session.isAdmin>
	...
	<cfif stMatch.col-1 GTE 1>
		...
		<cfinvoke component="type_se" method="getMatchesByCol" returnvariable="qMatches">
			<cfinvokeargument name="tournamentid" value="#qTournament.id#">
