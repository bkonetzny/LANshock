...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/dsp_type_de_matchdetails.cfm $
...
<cfoutput>
	<h4>#request.content.type_de_matchdetails_headline#</h4>
	<table align="center" width="80%">
		<cfif stMatch.status EQ 'empty' AND session.oUser.checkPermissions('manage')>
			<form action="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&#session.urltoken#" method="post">
				...
				<tr>
					<td align="center"><select name="team1">
						...
						<cfif isDefined("idTeam1")>
							<optgroup label="#request.content.type_de_matchdetails_selectbx_winnersofrelatedpreround#">
							<cfif idTeam1 EQ 0>
								<option value=""></option>
							<cfelse>
						...
						<cfif len(lWinners)>
							<optgroup label="#request.content.type_de_matchdetails_selectbx_allwinnersofpreround#">
							<cfloop list="#ListSort(StructKeyList(stTeams),'textnocase','asc')#" index="idx">
						...
						<optgroup label="#request.content.type_de_matchdetails_selectbx_allteams#">
				...
				<tr>
					<td align="center" colspan="2"><input type="submit" value="#request.content.type_de_matchdetails_saveassign#"></td>
				</tr>
			</form>
		<cfelse>
			<tr>
				<td align="center" width="50%">
					<cfscript>
						...
						if(stMatch.winner EQ keyTeam){
							sNamePre = '<strong>';
							sNamePost = '</strong>';
							teamstatus = request.content.type_de_status_team_won;
							...
							if(len(stMatch.winner)){
								...
								teamstatus = request.content.type_de_status_team_lost;
							}
							else{
			...
			<td colspan="2" align="center">
				...
				<table>
					<tr>
						<td valign="top">
							<fieldset>
								<legend>#request.content.type_de_matchdetails_info#</legend>
								<table width="100%">
									<tr>
										<td>#request.content.type_de_matchdetails_info_status#</td>
									...
									<tr>
										<td>#request.content.type_de_matchdetails_info_matchstatus#</td>
										<td align="center">
											<cfswitch expression="#stMatch.status#">
												<cfcase value="empty"><span style="color: orange">#request.content.type_de_matchdetails_status_save_teams#</span></cfcase>
												<cfcase value="play"><span style="color: green">#request.content.type_de_matchdetails_status_playing#</span></cfcase>
												<cfcase value="admincheck"><span style="color: orange">#request.content.type_de_matchdetails_status_admincheck#</span></cfcase>
												<cfcase value="done"><span style="color: green">#request.content.type_de_matchdetails_status_done#</span></cfcase>
											</cfswitch>
										</td>
									</tr>
									<cfif qTournament.teamsize EQ 1>
										<tr>
											<td>#request.content.type_de_matchdetails_info_result1#</td>
											<td align="center">
										...
										<tr>
											<td>#request.content.type_de_matchdetails_info_result2#</td>
											<td align="center">
									...
									<tr>
										<td>#request.content.type_de_matchdetails_info_result3#</td>
										<td align="center">
						...
						<cfif session.oUser.checkPermissions('manage')>
							<td valign="top">
								<fieldset>
									<legend>#request.content.type_de_matchdetails_statuschange#</legend>
										...
										<tr>
											<td>
												<cfif stMatch.status EQ 'empty'>
													<strong class="link_extended">#request.content.type_de_matchdetails_status_save_teams#</strong>
												<cfelse>
													<a href="#urlstring#empty" class="link_extended">#request.content.type_de_matchdetails_status_save_teams#</a>
												</cfif>
											</td>
										</tr>
										<tr>
											<td>
												<cfif stMatch.status EQ 'play'>
													<strong class="link_extended">#request.content.type_de_matchdetails_status_playing#</strong>
												<cfelse>
													<a href="#urlstring#play" class="link_extended">#request.content.type_de_matchdetails_status_playing#</a>
												</cfif>
											</td>
										</tr>
										<tr>
											<td>
												<cfif stMatch.status EQ 'admincheck'>
													<strong class="link_extended">#request.content.type_de_matchdetails_status_admincheck#</strong>
												<cfelse>
													<a href="#urlstring#admincheck" class="link_extended">#request.content.type_de_matchdetails_status_admincheck#</a>
												</cfif>
											</td>
										</tr>
										<tr>
											<td>
												<cfif stMatch.status EQ 'done'>
													<strong class="link_extended">#request.content.type_de_matchdetails_status_done#</strong>
												<cfelse>
													<a href="#urlstring#done" class="link_extended">#request.content.type_de_matchdetails_status_done#</a>
												</cfif>
											</td>
										</tr>
										<tr>
											<td><a href="#urlstring#reset" class="link_extended">#request.content.type_de_matchdetails_status_reset#</a></td>
										</tr>
									</table>
								</fieldset>
							</td>
		...
		<cfif session.oUser.checkPermissions('manage') AND stMatch.status EQ 'admincheck'>
			<tr>
				<td colspan="2" align="center"><br>&nbsp;<br>#request.content.type_de_matchdetails_set_winner#
					<table>
						<tr>
							<form action="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&#session.urltoken#" method="post">
							<input type="hidden" name="matchid" value="#stMatch.id#">
							...
							<td align="center"><input type="submit" value="#request.content.type_de_matchdetails_team1_winner#"<cfif stMatch.winner EQ 'team1'> disabled</cfif>></td>
							</form>
							<form action="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&#session.urltoken#" method="post">
							<input type="hidden" name="matchid" value="#stMatch.id#">
							<input type="hidden" name="form_submitted3" value="true">
							<input type="hidden" name="winner" value="">
							<td align="center"><input type="submit" value="#request.content.type_de_matchdetails_no_winner#"<cfif NOT len(stMatch.winner)> disabled</cfif>></td>
							</form>
							<form action="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&#session.urltoken#" method="post">
							<input type="hidden" name="matchid" value="#stMatch.id#">
							<input type="hidden" name="form_submitted3" value="true">
							<input type="hidden" name="winner" value="team2">
							<td align="center"><input type="submit" value="#request.content.type_de_matchdetails_team2_winner#"<cfif stMatch.winner EQ 'team2'> disabled</cfif>></td>
							</form>
						</tr>
					</table>
				</td>
		...
		<tr>
			<td colspan="2" align="center"><h4>#request.content.type_de_matchdetails_results#</h4></td>
		</tr>
		<cfif (qTournament.status EQ 'playing' AND stMatch.status EQ 'play' AND ListFind('#stMatch.team1.id#,#stMatch.team2.id#',qTeamCurrentUser.id)) OR (session.oUser.checkPermissions('manage') AND stMatch.status EQ 'admincheck')>
						...
						<table>
							...
							<cfloop from="1" to="#qTournament.matchcount#" index="idx">
								...
								<tr>
									...
									<td align="center">#request.content.type_de_resultdelimiter#</td>
							...
							<cfif iResultCountOriginal GTE qTournament.matchcount>
								<tr>
									<td colspan="3" align="center">#request.content.type_de_additional_rounds#</td>
								</tr>
							...
							<tr>
								<td colspan="3" align="center">&nbsp;<br><input type="submit" value="#request.content.type_de_submit_results_more#"></td>
							</tr>
							<tr>
								<td colspan="3" align="center">&nbsp;<br><input type="submit" name="finish" value="#request.content.type_de_submit_results_finish#"></td>
							</tr>
							</form>
						</table>
					</td>
			...
			<cfelse>
				<cfif stMatch.results.recordcount>
					<tr>
						<td colspan="2" align="center">#request.content.type_de_results_to_be_checked#</td>
					</tr>
					<tr>
						<td colspan="2" align="center">
							<table>
								<cfloop query="stMatch.results">
									<tr>
										...
										<td>#request.content.type_de_resultdelimiter#</td>
										<td>#team2_result#</td>
									</tr>
								</cfloop>
							</table>
					...
					<cfif ListFind('#stMatch.team1.id#,#stMatch.team2.id#',qTeamCurrentUser.id) AND qTeamCurrentUser.id NEQ stMatch.submittedby_teamid>
						...
						<input type="hidden" name="matchid" value="#stMatch.id#">
						<tr>
							<td colspan="2" align="center">&nbsp;<br><input type="submit" name="check1" value="#request.content.type_de_submit_results_check1#"> <input type="submit" name="check0" value="#request.content.type_se_submit_results_check0#"></td>
						</tr>
						</form>
					</cfif>
				<cfelse>
					<tr>
						...
						<input type="hidden" name="matchid" value="#stMatch.id#">
						<td colspan="2" align="center">
							<input type="submit" value="#request.content.type_de_submit_results#">
						</td>
						</form>
					</tr>
				</cfif>
