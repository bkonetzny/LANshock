	...
	<cfif session.oUser.checkPermissions('manage')>
		<div align="center">
			<cfif qTournament.status EQ 'warmup'>
				<a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&randomize_first_round=true&tournamentid=#qTournament.id#&#session.urltoken#" class="link_extended">#request.content.type_de_match_randomize_first_round#</a><br>
			</cfif>
			<a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&showstatus=false&tournamentid=#qTournament.id#&#session.urltoken#" class="link_extended">#request.content.type_de_match_markstatus#</a><br>
		</div>
	</cfif>
	<cfif qTeamCurrentUser.recordcount>
		<div align="center"><a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&markteam=#qTeamCurrentUser.id#&tournamentid=#qTournament.id#&#session.urltoken#" class="link_extended">#request.content.type_de_match_markteam#</a></div>
	</cfif>
	<br><br>
...
<cfif bRefreshView>
	<cflocation url="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&#session.urltoken#" addtoken="false">
</cfif>
