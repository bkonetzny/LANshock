...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/modules/tournament/dsp_type_customranking_ranking.cfm $
...
<cfif session.oUser.checkPermissions('manage')>
	<a href="#myself##myfusebox.thiscircuit#.ranking_edit&tournamentid=#qTournament.id#&#session.urltoken#" class="link_extended">#request.content.type_se_ranking_edit#</a>
</cfif>
