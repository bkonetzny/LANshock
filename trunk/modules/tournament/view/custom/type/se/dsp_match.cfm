...
<cfset iTeams = qTournament.currentteams>
<cfset iTeams = 2^Ceiling(LogN(iTeams,2))>
...
<cfoutput>
	...
	<ul class="options">
		<cfif session.oUser.checkPermissions('manage')>
			...
			<cfelseif qTournament.status EQ 'play'>
			...
			<cfif NOT attributes.showstatus>
				<li><a href="#application.lanshock.oHelper.buildUrl('#myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&showstatus=true')#">Matchstatus einblenden</a></li>
			<cfelse>
				<li><a href="#application.lanshock.oHelper.buildUrl('#myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&showstatus=false')#">#request.content.type_se_match_markstatus#</a></li>
			</cfif>
		</cfif>
		<cfif qTeamCurrentUser.recordcount>
			<li><a href="#application.lanshock.oHelper.buildUrl('#myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#&markteam=#qTeamCurrentUser.id#')#">#request.content.type_se_match_markteam#</a></li>
		</cfif>
	</ul>
	</cfif>
									...
									<cfloop from="1" to="#iBrackets#" index="row">
										...
										<tr class="match_container">
											...
											<td class="match_box match_box_status_">
												...
												<cfelse>
													#stHtmlMatches['blank']#
													<cfinvoke component="#application.lanshock.oFactory.load('lanshock.modules.tournament.model.type_se')#" method="createMatch">
...
<cfif bRefreshView>
	<cflocation url="#application.lanshock.oHelper.buildUrl('#myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&tournamentid=#qTournament.id#')#" addtoken="false">
</cfif>
