...
<cfoutput>
<div class="headline">#request.content.export_headline#</div>
<br>&nbsp;<br>
<fieldset>
...
<table width="100%">
	<tr>
		...
		<td width="50%" valign="top" align="center"><a href="http://www.wwcl.net" target="_blank"><img src="#UDF_Module('webPath')#export/wwcl.gif"></a></td>
	</tr>
	<tr>
		<td>
				...
				<tr>
					...
					<td>
						<cfif stExportData.WWCL.bGameini>
							<a href="#UDF_Module('webPath')#export/wwcl/gameini.xml" target="_blank"class="link_extended">#request.content.export_wwcl_gameini#</a><br>
							&nbsp;&nbsp;&nbsp; #request.content.export_wwcl_gameini_date# #UDF_DateTimeFormat(stExportData.WWCL.bGameiniDate)#<br>
						...
						&nbsp;<br><a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&wwcl_updategameini=true&#request.session.UrlToken#" class="link_extended">#request.content.export_wwcl_gameini_update#</a>
					</td>
				</tr>
			</table>
			<br>&nbsp;<br>
			<cfif fileExists('#UDF_Module('absPath')#/export/export.wwcl.xml')>
				<table>
					<tr>
						<td valign="top"><img src="#stImageDir.module#/export.gif" alt=""></td>
						<td>
							<a href="#UDF_Module('webPath')#export/export.wwcl.xml"class="link_extended">#request.content.export_exportfile#</a><br>
