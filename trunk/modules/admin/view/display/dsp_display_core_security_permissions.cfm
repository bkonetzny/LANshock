<cfsilent>
<!--- -->
<fusedoc fuse="$RCSfile: dsp_display_core_security_permissions.cfm,v $" language="ColdFusion 7.01" version="2.0">
	<responsibilities>
		I display a single core_security_permissions record from an object, a structure, a query or from attributes scope.
	</responsibilities>
	<properties>
		...
		<property name="lastupdated" value="$Date: 2008-03-09 12:47:41 +0100 (So, 09 Mrz 2008) 2008/05/12 14:11:56 $" />
	...
	<io>
		<in>
			...
			<object name="ocore_security_permissions" comments="The record object to be displayed." optional="Yes" />
			
			<structure name="stcore_security_permissions" comments="Not used if ocore_security_permissions is provided." optional="Yes" >
			...
			<recordset name="qcore_security_permissions" primaryKeys="id" scope="variables" optional="Yes" comments="Recordset containing core_security_permissions records " >
				<integer name="id" />
				<string name="name" />
				<string name="module" />
			...
			<integer name="id" scope="attributes" optional="Yes" comments="Not used if ocore_security_permissions, stcore_security_permissions or qcore_security_permissions is provided." />
			<string name="name" scope="attributes" optional="Yes" comments="Not used if ocore_security_permissions, stcore_security_permissions or qcore_security_permissions is provided." />
			<string name="module" scope="attributes" optional="Yes" comments="Not used if ocore_security_permissions, stcore_security_permissions or qcore_security_permissions is provided." />
...
<cfif isDefined("ocore_security_permissions")>
	<!--- Get variables from the object. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfif ListFindNoCase(_joinedFieldlist,thisField)>
			<cfset setvariable("variables.#thisField#", evaluate("ocore_security_permissions.get" & stJoinedFields[thisField] & "().get" & thisField & "()"))>
		<cfelse>
			<cfset setvariable("variables.#thisField#", evaluate("ocore_security_permissions.get" & thisField & "()"))>
		</cfif>
	</cfloop>
<cfelseif isDefined("stcore_security_permissions")>
	<!--- Copy variables from the structure. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfset setvariable("variables.#thisField#", stcore_security_permissions[thisField])>
	</cfloop>
<cfelseif isDefined("qcore_security_permissions")>
	<cfparam name="_recordNumber" default="1">
	<!--- Copy variables from the query. --->
	<cfloop list="#fieldlist#" index="thisField">
		<cfset setvariable("variables.#thisField#", qcore_security_permissions[thisField][_recordNumber])>
	</cfloop>
<cfelse>
...
<!--- Start of the form --->
<cfoutput>
	<table width="590" border="0" cellpadding="2" cellspacing="2" summary="This table shows details of a single core_security_permissions record." class="">
