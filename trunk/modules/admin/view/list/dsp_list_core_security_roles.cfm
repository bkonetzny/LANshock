<cfsilent>
<!--- -->
<fusedoc fuse="$RCSfile: dsp_list_core_security_roles.cfm,v $" language="ColdFusion 7.01" version="2.0"  >
	<responsibilities>
		This page displays a listing of the core_security_roles records from a recordset. 
	...
	<io>
		<in>
			...
			<number name="_totalRowCount" precision="integer" scope="variables" comments="Count of rows in the core_security_roles table." />
			<string name="_listSortByFieldList" default="">
			
			<recordset name="qcore_security_roles" primaryKeys="id" scope="variables" comments="Recordset containing core_security_roles records " >
	...
	Ext.onReady(function(){
	    ...
	    var grid = new xg.GridPanel({
	        ...
	        cm: new xg.ColumnModel([
	        	sm,
	        	{id:'id',header:'#jsStringFormat(request.content.core_security_roles_grid_header_id)#',width:30,sortable:true,dataIndex:'id'},{header:'#jsStringFormat(request.content.core_security_roles_grid_header_name)#',width:30,sortable:true,dataIndex:'name'},{header:'#jsStringFormat(request.content.core_security_roles_grid_header_module)#',width:30,sortable:true,dataIndex:'module'},
	        	action
	        ]),
	        sm: sm,
	        ...
	        height:533,
	        frame:false,
	        renderTo: Ext.get('grid_core_security_roles'),
