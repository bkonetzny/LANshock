...
<cfif session.oUser.isLoggedIn() AND session.oUser.getDataValue('userid') NEQ qUserData.id>
	...
	<ul class="options">
		<li><a href="javascript:LANshock.userSendMessage(#qUserData.id#);"><img src="#application.lanshock.oRuntime.getEnvironment().sWebPath#templates/_shared/images/famfamfam/icons/email.png" alt="#request.content.user_send_message#"> #request.content.user_send_message#</a></li>
...
<cfif session.oUser.isLoggedIn() AND (qUserData.data_access OR session.oUser.getDataValue('userid') EQ qUserData.id OR session.oUser.checkPermissions(area="user",module="admin"))>
	...
	<cfif session.oUser.getDataValue('userid') EQ qUserData.id OR session.oUser.checkPermissions(area="user",module="admin")>
		<cfif qUserData.data_access>
			<p><img src="#application.lanshock.oRuntime.getEnvironment().sWebPath#templates/_shared/images/famfamfam/icons/lightbulb.png" alt="Daten sind sichtbar" title="Daten sind sichtbar"/> Daten sind sichtbar</p>
		<cfelse>
			<p><img src="#application.lanshock.oRuntime.getEnvironment().sWebPath#templates/_shared/images/famfamfam/icons/lightbulb_off.png" alt="Daten sind nicht sichtbar" title="Daten sind nicht sichtbar"/> Daten sind nicht sichtbar</p>
		</cfif>
	</cfif>
