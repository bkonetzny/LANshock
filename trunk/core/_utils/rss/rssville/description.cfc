<cfcomponent name="description" extends="lanshock.core._utils.rss.rssville.rss">
<!---
...
--->
	...
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.description">
		<cfset super.init()>
