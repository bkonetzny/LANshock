<cfcomponent name="category" displayname="Feed Category" extends="lanshock.core._utils.rss.rssville.rss">
<!---
...
--->
	...
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.category">
		<cfset super.init()>
