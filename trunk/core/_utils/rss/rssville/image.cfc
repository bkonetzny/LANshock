<cfcomponent name="image" displayname="Feed Image" extends="lanshock.core._utils.rss.rssville.rss">
<!---
PROGRAM: image.cfc
UPDATES:
...
--->
	...
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.image">
		<cfset super.init()>
