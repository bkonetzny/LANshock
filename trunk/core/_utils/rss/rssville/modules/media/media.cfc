<cfcomponent name="media" extends="lanshock.core._utils.rss.rssville.rss">
<!---
PROGRAM: media.cfc
PURPOSE: 
UPDATES:
...
<!--- NOTES:
	media: 
		...
		* all values are limited to 255 characters, except for media:summary which is limited to 4000 characters
		* whitespace is significant and will show in media
--->
	...
	duration
	--->
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.media.media">
		<cfset super.init()>
		<cfset variables.instance.author=""><!--- media "Artist" --->
		...
		<cfset variables.instance[variables.instance.MODULE_NAME_KEY]="media"><!--- static --->
		<cfreturn this />
	</cffunction>
	...
	<cffunction name="generate_rss20" access="private" output="false" returntype="string">
		...
		<!--- <cfset sb.append(createXmlItem(getAuthor(), "media:author"))>
		<cfset sb.append(createXmlItem(getBlockYesNo(), "media:block"))>
		<cfset sb.append(createXmlItem(getExplicitYesNo(), "media:explicit"))>
		<cfset sb.append(createXmlItem(getKeywordsList(), "media:keywords"))>
		<cfset sb.append(createXmlItem(getSubTitle(), "media:subtitle"))>
		<cfset sb.append(createXmlItem(getSummary(), "media:summary"))> --->
