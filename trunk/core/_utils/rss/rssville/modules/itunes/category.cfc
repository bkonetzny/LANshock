<cfcomponent name="category" hint="Categories are defined by Apple. See ITMS for a view." extends="lanshock.core._utils.rss.rssville.rss">

	<cfset variables.instance = structNew()>
	
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.itunes.category">
		<cfset super.init()>
