<cfcomponent name="itunes" extends="lanshock.core._utils.rss.rssville.rss">
<!---
PROGRAM: itunes.cfc
PURPOSE: 
UPDATES:
...
--->
	...
	duration
	--->
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.itunes.itunes">
		<cfset super.init()>
