<cfcomponent name="enclosure" extends="lanshock.core._utils.rss.rssville.rss">
<!---
...
--->
	...
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.enclosure">
		<cfset super.init()>
