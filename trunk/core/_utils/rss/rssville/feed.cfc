<cfcomponent name="feed" extends="lanshock.core._utils.rss.rssville.rss">
<!---
PROGRAM: feed.cfc
...
--->
	...
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.feed">
		<cfset super.init()>
	...
	<cffunction name="addEntry" access="public" output="false" returntype="void">
		<cfargument name="entry" type="lanshock.core._utils.rss.rssville.entry" required="true" />
	...
	<cffunction name="setImage" access="public" output="false" returntype="void">
		<cfargument name="image" type="lanshock.core._utils.rss.rssville.image" required="true" />
