<cfscript>
	...
	// Creates a gateway of a given type from Reactor
	// usage:
	...
	if (fb_.verbInfo.executionMode is "start") {
		...
		if (not structKeyExists(fb_.verbInfo.attributes,"alias")) {
			fb_throw("fusebox.badGrammar.requiredAttributeMissing",
						...
						"The attribute 'alias' is required, for a 'gateway' verb in fuseaction #fb_.verbInfo.circuit#.#fb_.verbInfo.fuseaction#.");
		}
