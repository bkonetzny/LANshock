...
LANshock = {
	...
	getVar: function(key){
		return this.oProperties[key];
	},
	setVars: function(oProperties){
		this.oProperties = $.extend(this.oProperties, oProperties);
	},
	...
	Formatters: {
		formatBoolean: function(value){
			if (value) {
				return '<img src="' + LANshock.getVar('sWebPath') + 'templates/_shared/images/famfamfam/icons/bullet_green.png" alt=""/>';
			}
			else {
				return '<img src="' + LANshock.getVar('sWebPath') + 'templates/_shared/images/famfamfam/icons/bullet_red.png" alt=""/>';
			}
		},
		cfTimeStamp: function(value){
			if (value) {
