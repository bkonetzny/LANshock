<cfcomponent name="owner" extends="lanshock.core._utils.rss.rssville.rss">

	<cfset variables.instance = structNew()>

	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.itunes.owner">
		<cfset super.init()>
