<cfcomponent name="feed" extends="lanshock.core._utils.rss.rssville.modules.itunes.itunes"><!--- lanshock.core._utils.rss.rssville.module --->

	<cfset variables.instance = structNew()>
	
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.itunes.feed">
		<cfset super.init()>
	...
	<cffunction name="addCategory" access="public" output="false" returntype="void">
		<cfargument name="category" type="lanshock.core._utils.rss.rssville.modules.itunes.category" required="true" />
	...
	<cffunction name="addCategorySimple" access="public" output="false" returntype="void">
		...
		<cfset var category = CreateObject("component", "lanshock.core._utils.rss.rssville.modules.itunes.category").init() />
	...
	<cffunction name="getOwner" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.itunes.owner">
		<cfreturn variables.instance.owner />
	</cffunction>

	<cffunction name="setOwner" access="public" output="false" returntype="void">
		<cfargument name="owner" type="lanshock.core._utils.rss.rssville.modules.itunes.owner" required="true" />
	...
	<cffunction name="setOwnerSimple" access="public" output="false" returntype="void">
		...
		<cfset variables.instance.owner=CreateObject("component", "lanshock.core._utils.rss.rssville.modules.itunes.owner").init() />
