<cfcomponent name="duration" hint="The content of this tag is shown in the Time column in iTunes." extends="lanshock.core._utils.rss.rssville.rss">

	<cfset variables.instance = structNew()>

	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.itunes.duration">
		<cfset super.init()>
