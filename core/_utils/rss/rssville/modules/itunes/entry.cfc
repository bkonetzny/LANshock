<cfcomponent name="entry" extends="lanshock.core._utils.rss.rssville.modules.itunes.itunes">

	<cfset variables.instance = structNew()>
	
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.itunes.entry">
		<cfset super.init()>
		<cfset variables.instance.duration="">
		<cfreturn this />
	</cffunction>

	<cffunction name="getDuration" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.modules.itunes.duration">
		<cfreturn variables.instance.duration />
	</cffunction>

	<cffunction name="setDuration" access="public" output="false" returntype="void">
		<cfargument name="duration" type="lanshock.core._utils.rss.rssville.modules.itunes.duration" required="true" />
	...
	<cffunction name="setDurationSimple" access="public" output="false" returntype="void">
		...
		<cfset var duration = CreateObject("component", "lanshock.core._utils.rss.rssville.modules.itunes.duration").init() />
