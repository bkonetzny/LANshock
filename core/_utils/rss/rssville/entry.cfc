<cfcomponent name="entry" extends="lanshock.core._utils.rss.rssville.rss">
<!---
PROGRAM: entry.cfc
UPDATES:
...
--->
	...
	<cffunction name="init" access="public" output="false" returntype="lanshock.core._utils.rss.rssville.entry">
		<cfset super.init()>
	...
	<cffunction name="addCategory" access="public" output="false" returntype="void">
		<cfargument name="category" type="lanshock.core._utils.rss.rssville.category" required="true" />
	...
	<cffunction name="addCategorySimple" access="public" output="false" returntype="void">
		...
		<cfset var category = CreateObject("component", "lanshock.core._utils.rss.rssville.category").init() />
	...
	<cffunction name="setDescription" access="public" output="false" returntype="void">
		<cfargument name="description" type="lanshock.core._utils.rss.rssville.description" required="true" />
	...
	<cffunction name="setDescriptionSimple" access="public" output="false" returntype="void">
		...
		<cfset var description = CreateObject("component", "lanshock.core._utils.rss.rssville.description").init() />
	...
	<cffunction name="addEnclosure" access="public" output="false" returntype="void">
		<cfargument name="enclosure" type="lanshock.core._utils.rss.rssville.enclosure" required="true" />
	...
	<cffunction name="addEnclosureSimple" access="public" output="false" returntype="void">
		...
		<cfset var enclosure = CreateObject("component", "lanshock.core._utils.rss.rssville.enclosure").init() />
	...
	<cffunction name="addModule" access="public" output="false" returntype="void">
		<cfargument name="module" type="lanshock.core._utils.rss.rssville.rss" required="true" />
