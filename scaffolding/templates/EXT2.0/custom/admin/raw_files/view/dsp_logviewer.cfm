...
<cfoutput>
	...
	<table class="list">
		...
		<cfloop query="qLogs">
			<tr>
				<td><a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&logfile=#name#&#session.urltoken#" target="_blank">#name#</a></td>
				<td align="right">#size#</td>
				<td>#UDF_DateTimeFormat(datelastmodified)#</td>
				<td class="empty"><a href="#myself##myfusebox.thiscircuit#.#myfusebox.thisfuseaction#&deletefile=#name#&#session.UrlToken#"><img src="#stImageDir.general#/btn_delete.gif" alt="#request.content.form_delete#"></a></td>
			</tr>
		</cfloop>
	</table>
</cfoutput>
