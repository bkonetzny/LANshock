...
<table>
	<form action="#myself##myfusebox.thiscircuit#.rights_update&#session.UrlToken#" method="post">
	...
	<tr>
		<td><a href="#myself##myfusebox.thiscircuit#.admin&#session.UrlToken#"class="link_extended">#request.content.back#</a></td>
	</tr>
</table>
</cfoutput>
