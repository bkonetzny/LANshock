...
<cfoutput>
	...
	<a href="#myself##myfusebox.thiscircuit#.admin_new&#session.UrlToken#"class="link_extended">#request.content.orga2#</a>
	...
	<table class="list">
		...
		<cfloop list="#ListSort(StructKeyList(stAdmins),'textnocase','ASC')#" index="CurrUser">
			<tr>
				<td><a href="#myself##myfusebox.thiscircuit#.show_modulrights&userid=#stAdmins[curruser].id#&#session.UrlToken#">#curruser#</a></td>			
				<td>
				...
				<cfif UDF_SecurityCheck(area='setrights',returntype='boolean')>
					<td class="empty"><a href="#myself##myfusebox.thiscircuit#.admin_del&admin_id=#stAdmins[curruser].admin_id#&#session.UrlToken#"><img src="#stImageDir.general#/btn_delete.gif" alt="#request.content.form_delete#"></a></td>
				</cfif>
			</tr>
		</cfloop>
	</table>
