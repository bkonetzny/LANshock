...
$HeadURL: https://svn.sourceforge.net/svnroot/lanshock/trunk/core/admin/qry_deluser.cfm $
...
<CFlocation url="#self#?fuseaction=#UDF_Module()#.userlist&#session.UrlToken#" addtoken="Yes">
