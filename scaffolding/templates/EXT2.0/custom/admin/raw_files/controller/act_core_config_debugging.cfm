...
<cfif attributes.form_submitted>
	...
	<cfset stModuleConfigNew.settings.debug.show_plain_error = attributes.show_plain_error>
	<cfset stModuleConfigNew.settings.debug.mail_error = attributes.mail_error>
	<cfset stModuleConfigNew.settings.debug.error_email = attributes.error_email>
