		...
		<cfif StructKeyExists(attributes.stFieldData,'parent')>
			<select name="#attributes.stFieldData.alias#" id="formrow_#attributes.stFieldData.uuid#">
				...
				#chr(60)#cfloop query="stRelated.#attributes.stFieldData.parent#.qData">
					<option value="##stRelated.#attributes.stFieldData.parent#.qData.optionvalue##"#chr(60)#cfif o#caller.objectName#.get#attributes.stFieldData.alias#() EQ stRelated.#attributes.stFieldData.parent#.qData.optionvalue> selected="selected"#chr(60)#/cfif>>##stRelated.#attributes.stFieldData.parent#.qData.optionname##</option>
				#chr(60)#/cfloop>
			</select>
		<cfelse>
