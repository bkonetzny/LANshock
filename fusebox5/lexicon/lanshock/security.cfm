...
<cfscript>
	if (fb_.verbInfo.executionMode is "start") {
		...
		fb_appendLine('<cflocation url="##myfusebox.getMyself()##c_general.noright&right_module=##myfusebox.thiscircuit##&right_area=#fb_.verbInfo.attributes.area#&#session.urltoken#" addtoken="false">');
		fb_appendLine('</cfif>');
